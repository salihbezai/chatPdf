...
const Dashboard = () => {
  ...
  return (
    <main className='mx-auto max-w-7xl md:p-10'>
      <div className='mt-8 flex flex-col ites-start justify-between 
      gap-4 border-b border-gray-200 sm:flex-row sm:items-center sm:gap-0'>
      ...
      { files && files?.length !== 0 ? (
        ...
        <div className='mt-16 flex flex-col items-center gap-2'>
          ...
          <p>Let&apos;s upload your firs PDF.</p>
        </div>
      )}
    </main>
  )
